...
export const translations = {
  ...
  ar: {
    ...
    "hero.tagline": " تركيب وصيانة وتوسيع الشبكات الحديثة. خبرة عملية تزيد عن 4 سنوات في البنية التحتية وحل المشكلات",
    "hero.cvbtn": "عرض السيرة",
    "hero.contactbtn": "تواصل معي",
    "about.title": "نبذة عني",
    "about.text": "مهندس شبكات حديث التخرج، لكنني أمتلك خبرة عملية ميدانية في تركيب وإدارة العديد من الشبكات السلكية واللاسلكية وادارة وبرمجة المايكروتك، بالإضافة إلى أنظمة المراقبة (CCTV). قمت شخصيًا بتجهيز وتشغيل شبكات فعلية، وتعاملت مع إعدادات الأجهزة، توزيع العناوين، وضبط إعدادات الأمان الأساسية.\n\nإلى جانب العمل التنفيذي، أقدم دراسات فنية وجدوى لتركيب هذه الأنظمة، حيث أحلل الاحتياج الفعلي للعميل، وأقترح التصميم المناسب، وأحدد المعدات المطلوبة ضمن الميزانية المتاحة، مع مراعاة ظروف العمل في اليمن (انقطاع التيار، ضعف البنية التحتية، توفر القطع).\n\nأمتلك مهارات في تأمين الشبكات، تشخيص الأعطال وحلّها، وتقديم الدعم الفني للمستخدمين. أعمل بكفاءة تحت الضغط، وأركز على حلول عملية وآمنة. لدي اهتمام بتطبيقات الذكاء الاصطناعي في تحسين كفاءة الشبكات والمراقبة، وأطوّر نفسي باستمرار في هذا المجال.\n\nكوني يمني، تعلمت تقديم حلول واقعية بإمكانيات محدودة، والالتزام بالأمانة والمصداقية في كل مشروع." ,
